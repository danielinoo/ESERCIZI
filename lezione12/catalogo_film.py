...
class MovieCatalog:
    ...
    def remove_film(self,director_name,name_film):

        if director_name in self.catalogo:

            if name_film in self.catalogo[director_name]:

                    self.catalogo[director_name].remove(name_film)
